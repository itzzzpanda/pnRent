...
$(document).on('click', '.pay-button', function (e) {
  ...
  $.post(`https://${GetParentResourceName()}/pnRental:rent`, JSON.stringify({
    carName: carName,
    carPrice: carPrice,
...
$(document).on('click', '.category-box .item', function (e) {
  ...
  $('.category-box .item').children('i').css('color','#5c5f54')
  $('.category-box .item').children('.name').css('color','#8e8e88')

  $(this).css('background-color','rgba(51, 66, 9, 0.5)')
  $(this).css('border','1px solid #89c715')
  $(this).children('i').css('color','#89c715')
  $(this).children('.name').css('color','#89c715')
...
$(document).on('click', '.car-box .car-item', function (e) {
  ...
  $('.car-box .car-item').children('i').css('color','#5c5f54')
